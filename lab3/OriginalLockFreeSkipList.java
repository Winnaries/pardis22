...
public final class OriginalLockFreeSkipList<T> {
    /* Number of levels */
    ...
    public OriginalLockFreeSkipList() {
        for (int i = 0; i < head.next.length; i++) {
            head.next[i] = new AtomicMarkableReference<OriginalLockFreeSkipList.Node<T>>(tail, false);
        }
    }
