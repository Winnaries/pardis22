...
public final class LockFreeSkipList<T> {
	...
	@SuppressWarnings("unchecked")
	public boolean add(T x, LockFreeSkipListRecordBook<T> book) {
	...
	@SuppressWarnings("unchecked")
	public boolean remove(T x, LockFreeSkipListRecordBook<T> book) {
		long start = System.nanoTime();
	...
	public boolean contains(T x, LockFreeSkipListRecordBook<T> book) {
		long start = System.nanoTime();
